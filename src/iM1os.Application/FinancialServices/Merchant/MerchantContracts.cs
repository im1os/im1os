...
public sealed record MerchantApplicationRequest(
    ...
    decimal? KeyEnteredPercentage,
    decimal? EcommercePercentage,
    decimal? MotoPercentage,
    string? Website,
    string? Mcc,
    string ProviderCode = "NMI");
...
public sealed record CompanyMerchantAccountWorkspace(
    ...
    MerchantLegalConsentModel LegalConsent);

public sealed record MerchantLegalConsentModel(
    bool IsRequired,
...
public sealed record MerchantApplicationFormModel(
    ...
    string? OwnerTitle,
    decimal? OwnerOwnershipPercentage,
    string? OwnerDateOfBirthMasked,
    string? OwnerSsnLastFour,
    string? BankName,
...
public sealed record PlatformMerchantAccountRow(
    ...
    string? ProviderReference,
    string? ProviderRelationshipStatus,
    string? CredentialProvisioningStatus,
    string? LastProviderError,
    string? SupportNotes,
    DateTimeOffset? ProviderApplicationCreatedAtUtc,
    DateTimeOffset? LegalConsentCompletedAtUtc,
    DateTimeOffset? ProviderApplicationSubmittedAtUtc,
    DateTimeOffset? ProviderStatusRefreshedAtUtc,
    DateTimeOffset? ProviderApprovedAtUtc,
    DateTimeOffset? CredentialsProvisionedAtUtc,
